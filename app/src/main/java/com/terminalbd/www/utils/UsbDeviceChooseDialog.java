...
import com.terminalbd.www.adapter.UsbDeviceAdapter;
import com.terminalbd.www.receiver.UsbDeviceReceiver;
...
/*    private void initData() {
        ...
        Log.v(TAG, "accessories length = " + accessories.length);
        for (int i = 0; i < accessories.length; i++) {
            UsbAccessory accessory = accessories[i];
            Log.v(TAG, "accessories toString = " + accessory.toString());
        }
    }*/
