...
public class PurchaseEditActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public PurchaseEditActivity_ViewBinding(PurchaseEditActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PurchaseEditActivity_ViewBinding(final PurchaseEditActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PurchaseEditActivity target = this.target;
