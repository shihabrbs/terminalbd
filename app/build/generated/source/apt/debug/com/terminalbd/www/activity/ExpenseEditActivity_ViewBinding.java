...
public class ExpenseEditActivity_ViewBinding implements Unbinder {
  private ExpenseEditActivity target;
  ...
  @UiThread
  public ExpenseEditActivity_ViewBinding(ExpenseEditActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ExpenseEditActivity_ViewBinding(final ExpenseEditActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ExpenseEditActivity target = this.target;
